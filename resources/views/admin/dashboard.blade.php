...
@section('content')
    ...
    <div class="row" acl-tag="admin.dashboard.log.chart">
                    ...
                    <div class="col-md-6">
                        <div class="date_piker pull-right"
                            ...
                            <span class="date_piker_label">
                                {{ \Carbon\Carbon::now()->addDays(-6)->format('F j, Y') }}
    ...
    <div class="row" acl-tag="admin.dashboard.registration.chart">
...
@section('scripts')
    ...
    <script type="text/javascript">
        ...
        $('[acl-tag]').each(function () {
            let aclTag = $(this).attr('acl-tag');
            if (!permissions.find(permission => permission.permission_slug == aclTag)) {
                $(this).html('');
            }
        });
    </script>
